...
![Função par](./04-funcoes/img/aula06-img01.png)
...
Ao observar seu gráfico, percebemos que elas são simétricas em relação à origem: se rotacionarmos o gráfico em $180^o$ ao redor da origem, o gráfico se mantém inalterado.

--

![Função ímpar](./04-funcoes/img/aula06-img02.png)
...
![Função crescente](./04-funcoes/img/aula06-img03.png)
...
![Função decrescente](./04-funcoes/img/aula06-img04.png)
...
Funções **injetoras** são aquelas que levam elementos diferentes do domínio em imagens diferentes no contradomínio. 
