...
Pode ser reescrita como $$-5 \le x \le 5$$

Logo, a solução é o intervalo $[-5,5]$.
...
$$|x| > 6$$
Pode ser reescrita como $$x > 6 \text{ ou } x < -6$$

A solução é $(-\infty, -6)\cup (6,\infty)$

--

**Exemplo 5**
Podemos incrementar o Exemplo 3. Considere $L=5$. A inequação abaixo 
$$|x-4| < 5$$
...
**Exemplo 6**
Podemos incrementar o Exemplo 4. Considere $M=6$. A inequação abaixo 
$$|x-2| \ge 6$$
...
[Voltar ao conteúdo](./01-conjuntos/aula05)