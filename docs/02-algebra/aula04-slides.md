...
- $7^2 = 49$ então $\sqrt[2]{49} = 7$
- $(-2)^3 = -8$ então $\sqrt[3]{-8} = -2$
- $3^4 = 81$ então $\sqrt[4]{81} = 3$
...
Lembrando o conteúdo visto na [Aula 01](./02-algebra/aula01), raízes são potências fracionárias
